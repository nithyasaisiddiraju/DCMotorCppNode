...
## Generated on : Tue Jan 21 10:09:37 2025
## Final product: ./simple_state_space.a
...
START_DIR                 = /Users/nithyasai/Documents/MATLAB/Examples/R2024b/control/dcdemo/finalcode
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I/Users/nithyasai/Documents/MATLAB/Examples/R2024b/control/dcdemo -I$(MATLAB_ROOT)/extern/include
...
SRCS = $(START_DIR)/simple_state_space_initialize.cpp $(START_DIR)/simple_state_space_terminate.cpp $(START_DIR)/simple_state_space.cpp
...
%.o : /Users/nithyasai/Documents/MATLAB/Examples/R2024b/control/dcdemo/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : /Users/nithyasai/Documents/MATLAB/Examples/R2024b/control/dcdemo/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : /Users/nithyasai/Documents/MATLAB/Examples/R2024b/control/dcdemo/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : /Users/nithyasai/Documents/MATLAB/Examples/R2024b/control/dcdemo/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : /Users/nithyasai/Documents/MATLAB/Examples/R2024b/control/dcdemo/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
simple_state_space_initialize.o : $(START_DIR)/simple_state_space_initialize.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


simple_state_space_terminate.o : $(START_DIR)/simple_state_space_terminate.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


simple_state_space.o : $(START_DIR)/simple_state_space.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
