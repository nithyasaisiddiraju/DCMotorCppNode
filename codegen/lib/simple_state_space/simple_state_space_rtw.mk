...
## Generated on : Mon Jan 20 12:27:51 2025
...
INCLUDES_BUILDINFO = -I$(START_DIR)/codegen/lib/simple_state_space -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include
...
SRCS = $(START_DIR)/codegen/lib/simple_state_space/simple_state_space_initialize.cpp $(START_DIR)/codegen/lib/simple_state_space/simple_state_space_terminate.cpp $(START_DIR)/codegen/lib/simple_state_space/simple_state_space.cpp
...
%.o : $(START_DIR)/codegen/lib/simple_state_space/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/simple_state_space/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/simple_state_space/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/codegen/lib/simple_state_space/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/codegen/lib/simple_state_space/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
simple_state_space_initialize.o : $(START_DIR)/codegen/lib/simple_state_space/simple_state_space_initialize.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


simple_state_space_terminate.o : $(START_DIR)/codegen/lib/simple_state_space/simple_state_space_terminate.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


simple_state_space.o : $(START_DIR)/codegen/lib/simple_state_space/simple_state_space.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
